import {mountMap} from '../lib/view/exploration';
...
if(data&&root){const {page,base,groups}=JSON.parse(data.textContent!);mountSpoilers(root,page,base,groups);mountMap(root);}
